...
// rotas HTTP (producer -> farm -> planted-crop), e o item central do gate
// da sub-etapa 5.1: GET /dashboard nunca recalcula por requisição fora do
// cold start — só o DashboardCacheRefreshScheduler (rodando em bootstrap e
// depois periodicamente, fora do tráfego) chama a agregação de verdade.
// Isso é provado espionando o método real da porta de leitura
